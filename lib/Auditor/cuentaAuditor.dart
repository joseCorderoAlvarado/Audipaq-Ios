...
import 'conversionesCuentaAuditor.dart';
...
Future<DatosCuentaAuditor> listadoMaestro;
  @override
  void initState() {
    super.initState();
  ...
  listadoMaestro = obtenerDatosCuentaAuditor(correo);
  }
...
return ScopedModelDescendant<MainModel>(
    ...
    return  FutureBuilder<DatosCuentaAuditor>(
        ...
        itemBuilder: (context, index) {
          DatosCuentaAuditor project = projectSnap.data;
          return Column(
