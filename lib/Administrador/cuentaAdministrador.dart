...
import 'conversionesCuentaAministrador.dart';



// Clase del Home Auditor
class CuentaAdministrador extends StatefulWidget {




  CuentaAdministrador({Key key}) : super(key: key);

  @override
  _CuentaAdministrador createState() {
    return _CuentaAdministrador();
  }
}
...
class _CuentaAdministrador extends State<CuentaAdministrador> {
  //Variables de preferencia aqui.

Future<DatosCuentaAdministrador> listadoMaestro;
  @override
  void initState() {
    super.initState();
  ...
  listadoMaestro = obtenerDatosCuentaAdministrador(correo);
  }
...
return ScopedModelDescendant<MainModel>(
    ...
    return  FutureBuilder<DatosCuentaAdministrador>(
        ...
        itemBuilder: (context, index) {
          DatosCuentaAdministrador project = projectSnap.data;
          return Column(
